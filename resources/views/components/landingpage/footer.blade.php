      @if ($abouts)
          ...
          <footer class="footer-section footer-bg" id="contact">
              <div class="container">
              ...
              <div class="footer-widgets-wrapper">
                  ...
                  <div class="container">
                      <div class="row">
                          <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                              <div class="single-footer-widget">
                                  ...
                                  <div class="footer-content">
                                      <p>
                                          {!! Str::words(strip_tags($abouts->body), 30, '...') !!}
                                      </p>
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-6 ps-lg-5 wow fadeInUp" data-wow-delay=".5s">
                              <div class="single-footer-widget">
                                  <div class="widget-head">
                                      <h3>Quick Links</h3>
                                  </div>
                  ...
                  <div class="container">
                      <div class="footer-wrapper d-flex align-items-center justify-content-between">
                          <p class="wow fadeInLeft color-2" data-wow-delay=".3s">
                              © All Copyright 2025 by <a href="{{ $abouts->instagram_url }}">Hmpi Informatika UPY </a>
                          </p>
                      </div>
                  </div>
                  <a href="#home" id="scrollUp" class="scroll-icon">
          ...
          <footer class="footer-section footer-bg" id="contact">
                      ...
                      <div class="row">
                          <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                              <div class="single-footer-widget">
                                  ...
                                  <div class="footer-content">
                                      <p>
                                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem ad expedita eaque
                                          laboriosam, tenetur nobis. Velit eaque in aspernatur dolores non alias
                                          doloremque. Ad, facilis qui. Porro in quasi earum?
                                      </p>
                                      <div class="social-icon d-flex align-items-center">
              ...
              <div class="footer-bottom style-2">
                  <div class="container">
                      <div class="footer-wrapper d-flex align-items-center justify-content-between">
                          <p class="wow fadeInLeft color-2" data-wow-delay=".3s">
                              © All Copyright 2025 by <a
                                  href="https://www.instagram.com/hmpinformatika_upy?igsh=MTZjdzg3YWp0ZjhmeA=="
                                  target="_blank">Hmpi Informatika UPY </a>
                          </p>
                      </div>
                  </div>
                  <a href="#home" id="scrollUp" class="scroll-icon">
