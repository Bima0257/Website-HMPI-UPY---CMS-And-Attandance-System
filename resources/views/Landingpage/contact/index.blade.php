<x-Landingpage.layout title="{{ $title }}">
                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="contact-content">
                            ...
                            <p>
                                Kami dari Himpunan Mahasiswa Informatika UPY selalu terbuka untuk menjalin kerja sama,
                                menerima masukan, maupun berbagi ide demi pengembangan bersama.
                                Jangan ragu untuk menghubungi kami dan tinggalkan pesan Anda —
                                setiap saran dan kerja sama sangat berarti bagi kami.
                            </p>

                            <form action="{{ route('messages.store') }}" id="contact-form" method="POST"
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-12 wow fadeInUp" data-wow-delay=".7s">
                                        <div class="form-clt">
                                            <span>Asal Institusi / Universitas / Komunitas </span>
                                            <input type="text" name="asal" id="asal"
                                                placeholder="Asal Institusi / Universitas / Komunitas"
                                                autocomplete="off">
                                        </div>
                                    </div>
    ...
    <div class="map-section">
        <div class="map-items">
            <div class="googpemap">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.84426070402!2d110.33841297430654!3d-7.806306477498246!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a57fac27e70db%3A0x6ac4a4807ca11460!2sUniversitas%20PGRI%20Yogyakarta%20(Kampus%20Pusat)!5e0!3m2!1sid!2sid!4v1754310138318!5m2!1sid!2sid"
        ...
        @if (session('success'))
            ...
            if (!sessionStorage.getItem(messageId)) {
                Swal.fire({
                    ...
                    timer: 3000, // ✅ auto hilang 3 detik
                    timerProgressBar: true,
                    background: '#f0f9eb', // ✅ background lembut hijau
        ...
        @if (session('error'))
            ...
            if (!sessionStorage.getItem(messageId)) {
                Swal.fire({
                    ...
                    timer: 3000,
                    timerProgressBar: true,
                    background: '#fbeaea', // ✅ background lembut merah
